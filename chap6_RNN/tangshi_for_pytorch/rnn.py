...
class RNN_model(nn.Module):
    ...
    def forward(self,sentence,is_test = False):
        ...
        h_init = torch.zeros(self.layer_nums, batch_input.size(0), self.lstm_dim, device=device)
        c_init = torch.zeros(self.layer_nums, batch_input.size(0), self.lstm_dim, device=device)
